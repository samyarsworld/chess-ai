...
<a name="usage"></a>
## Usage
A link to executable file to play this game is here: For Windows users <a style="text-decoration:none; color:inherit;" href="https://drive.google.com/file/d/1whberk3yM7k9m4i6Gn-LHCxXZ84Q8WeH/view?usp=share_link"><span style="color:blue;">CLICK HERE</span></a>. For Linux users <span style="color:orange;"><a style="text-decoration:none; color:inherit;" href="https://drive.google.com/file/d/1acJsgsbm9qi27_SazzMhxmidVgkWVjsD/view?usp=share_link">CLICK HERE</a></span>. After downloading the zip file, simply unzip and run the executable file.
