...
def options():
    while True:
        ...
        MEDIUM_BUTTON = Button(image=pygame.image.load("assets/images/Options Rect.png"), pos=(640, 340), 
                            text_input="MEDIUM", font=get_font(FONT_SIZE2), base_color="#d7fcd4", hovering_color=(0, 255, 0))
        HARD_BUTTON = Button(image=pygame.image.load("assets/images/Quit Rect.png"), pos=(640, 460), 
                            text_input="HARD", font=get_font(FONT_SIZE2), base_color="#d7fcd4", hovering_color=(0, 255, 0))
        BACK_BUTTON = Button(image=pygame.image.load("assets/images/Quit Rect.png"), pos=(640, 580), 
